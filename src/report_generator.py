...
class HTMLReportGenerator:
    ...
    def __init__(self, template_dir: Path = None):
        ...
        logger.info(f"报告生成器初始化: {self.template_dir}")

    def generate_html(self, analysis_data: Dict, output_file: str) -> str:
        """
        生成 HTML 报告
...
if __name__ == "__main__":
    ...
    result = generator.generate_html(mock_data, output_file)
    print(f"测试报告已生成: {result}")
